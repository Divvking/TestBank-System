...
A full-stack assessment platform for managing question banks, conducting tests, and analyzing student performance — with role-based access for administrators, faculty, and students.
...
**Key tables**
`user`, `role`, `question`, `category`, `test`, `test_question`, `attempt`, `response`, `result`
...
- Backend uses a validated schema (no auto DDL changes)
